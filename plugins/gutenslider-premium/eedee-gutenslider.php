...
// phpcs:disable
/**
 * Plugin Name: Gutenslider — The last WordPress slider you will ever need. (Premium)
 ...
 * @package Gutenslider
 *
 * @fs_premium_only /build/gutenslider-pro.js src/blocks/blocks_pro.js src/blocks/gutenslider/pro src/blocks/gutenslide/pro
 */
...
if ( function_exists( 'gutenslider_fs' ) ) {
    gutenslider_fs()->set_basename( true, __FILE__ );
} else {
