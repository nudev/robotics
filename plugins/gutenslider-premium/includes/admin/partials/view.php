<div class="wrap gutenslider-admin">
		...
		<div class="container">
			<div class="row gs-admin-intro flex">
				...
				<div class="col-12 col-md-3 d-flex align-items-center text-right">
					<div>Like the plugin? <br> <a href="<?php echo esc_url( GUTENSLIDER_REVIEW_URL ); ?>">Leave a ⭐️⭐️⭐️⭐️⭐️ review</a></div>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 d-flex align-items-center">
					<img class="py-5" src="<?php echo esc_url( GUTENSLIDER_PLUGIN_URL . 'build/images/gutenslider_start_image.svg' ); ?>" alt="gutenslider start image" />
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-md-6 py-5">
					<div class="blog-post">
						...
						<a href="https://gutenslider.org/gutenslider-tutorial-how-to-add-sliders-to-your-wordpress-website/" ><img class="py-3" src="<?php echo esc_url( GUTENSLIDER_PLUGIN_URL . 'build/images/adding-gutenslider-block-1600x849.png' ); ?>" /></a>
				...
				<div class="col-md-6 py-5">
					<div class="blog-post">
						...
						<a href="https://gutenslider.org/wordpress-fullscreen-background-slider/" ><img class="py-3" src="<?php echo esc_url( GUTENSLIDER_PLUGIN_URL . 'build/images/samuel-zeller-158996-unsplash.png' ); ?>" /></a>
						<div class="post-description py-3">
							With Gutenslider, it is very easy to add custom sliders to your WordPress website or blog. Unlike many other sliders, Gutenslider is fully integrated into the gutenberg editor backend. In this post, we will show you, how to integrate sliders very fast and simple. The tutorial covers the basics of how to add sliders.
						</div>
	...
	<?php if ( gutenslider_fs()->is_not_paying() ) { ?>
	...
	if ( gutenslider_fs()->is__premium_only() ) {
		...
		<section class="thankyou py-5">
			<div class="container">
		<?php if ( gutenslider_fs()->is_plan( 'pro', true ) ) { ?>
			<h4>Thank you for buying Gutenslider Pro</h4><p>You are helping us to improve the plugin and give support.</p>
		<?php } elseif ( gutenslider_fs()->is_plan( 'expert' ) ) { ?>
			<h4>Thank you for buying Gutenslider Expert </h4><p>You are helping us to improve the plugin and give support.</p>
		<?php } ?>
			</div>
		</section>
		<?php
	...
	?>
	<?php if ( isset( $parsedChangelog ) && '' !== $parsedChangelog ) { ?>
	<section class="changelog py-5">
		<div class="container-fluid">
			<div class="row">
				<div class="gs-logo-container col-md-5">
					<img src="<?php echo esc_url( GUTENSLIDER_PLUGIN_URL . 'build/images/gutenslider_logo-300x300.png' ); ?>" alt="gutenslider logo" />
				</div>
				<div class="col-md-7">
					<h2>Changelog</h2>
					<div class="changelog-container">
						<?php echo $parsedChangelog ?>
					</div>
				</div>
			</div>
		</div>
