...
class NU_ACF_Blocks
{
	...
	private function includes(){
		...
		// require_once( get_template_directory(  ) . '/classes/acf-blocks/accordion/accordion.php' );
		// require_once( get_template_directory(  ) . '/classes/acf-blocks/accordion/accordion-item/accordion-item.php' );

		require_once( get_template_directory(  ) . '/classes/acf-blocks/showcase-panel/showcase-panel.php' );
