<?php
	...
	register_block_pattern(
		'nublocks/featured-items/type-a',
		array(
			...
			'content'     => '
				...
				<div id="Feature-Type-A" class="wp-block-group nu_pattern-is_feature--is_type_a has-background" style="background-color:#efefef"><!-- wp:columns -->
				...
				<div class="wp-block-group"><!-- wp:paragraph {"className":"is-style-links-have-arrows"} -->
				...
				<!-- wp:column {"width":"60%"} -->
				<div class="wp-block-column" style="flex-basis:60%"><!-- wp:paragraph {"className":"is-style-default","fontSize":"larger"} -->
