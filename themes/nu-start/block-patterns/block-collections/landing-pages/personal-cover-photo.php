<?php
	...
	register_block_pattern(
		'nublocks/landing-pages/personal-cover-photo',
		array(
			...
			'content'     => '
				...
				<figure class="wp-block-image size-full"><img src="'.get_template_directory_uri().'/__lib/img/1920x1080.png" alt="" class="wp-image-21"/></figure>
				<!-- /wp:image -->
