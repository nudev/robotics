<?php
	...
	register_block_pattern(
		'nublocks/landing-pages/generic-landing-page',
		array(
			...
			'content'     => '
				...
				<div class="wp-block-cover" style="min-height:30vw"><img class="wp-block-cover__image-background wp-image-298" alt="" src="'.get_template_directory_uri().'/__lib/img/1920x1080.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
