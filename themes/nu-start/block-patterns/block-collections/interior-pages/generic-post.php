<?php
	...
	register_block_pattern(
		'nublocks/interior-pages/generic-post',
		array(
			...
			'content'     => '
				...
				<div class="wp-block-column" style="flex-basis:320px"><!-- wp:image {"align":"center"} -->
				<div class="wp-block-image"><figure class="aligncenter"><img src="'.get_template_directory_uri().'/__lib/img/1920x1080.png" alt="Pharmacist with drugs"/><figcaption>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam id dolor id nibh ultricies vehicula ut id elit</figcaption></figure></div>
				<!-- /wp:image --></div>
				<!-- /wp:column --></div>
				<!-- /wp:columns -->
				
				<!-- wp:columns {"className":"is-style-justify-space-between"} -->
				<div class="wp-block-columns is-style-justify-space-between"><!-- wp:column {"width":"320px"} -->
				<div class="wp-block-column" style="flex-basis:320px"><!-- wp:image {"align":"center"} -->
				<div class="wp-block-image"><figure class="aligncenter"><img src="'.get_template_directory_uri().'/__lib/img/1920x1080.png" alt="Pharmacist with drugs"/><figcaption>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam id dolor id nibh ultricies vehicula ut id elit</figcaption></figure></div>
				<!-- /wp:image --></div>
				<!-- /wp:column -->
