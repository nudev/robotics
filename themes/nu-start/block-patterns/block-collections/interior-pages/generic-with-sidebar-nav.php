<?php
	...
	register_block_pattern(
		'nublocks/interior-pages/generic-with-sidbar-nav',
		array(
			'title'       => 'Interior Page - Generic with Sidebar Nav',
			...
			'content'     => '
				...
				<div class="wp-block-group alignfull nu_pattern-is_hero_banner--type-c" id="banner-type-c"><!-- wp:cover {"url":"'.get_template_directory_uri().'/__lib/img/1920x1080.png","id":295,"dimRatio":0,"focalPoint":{"x":"0.50","y":0.5},"minHeight":20,"minHeightUnit":"vw","align":"full"} -->
				<div class="wp-block-cover alignfull" style="min-height:20vw"><img class="wp-block-cover__image-background wp-image-295" alt="" src="'.get_template_directory_uri().'/__lib/img/1920x1080.png" style="object-position:50% 50%" data-object-fit="cover" data-object-position="50% 50%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"color":{"gradient":"linear-gradient(135deg,rgba(0,0,0,0.66) 3%,rgba(0,0,0,0.66) 100%)"}}} -->
