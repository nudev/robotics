<?php
	...
	register_block_pattern(
		...
		array(
			...
			'content'     => '
				<!-- wp:cover {"url":"'.get_template_directory_uri().'/__lib/img/1920x1080.png","id":295,"dimRatio":0,"minHeight":30,"minHeightUnit":"vw","align":"full"} -->
				<div class="wp-block-cover alignfull" style="min-height:30vw"><img class="wp-block-cover__image-background wp-image-295" alt="" src="'.get_template_directory_uri().'/__lib/img/1920x1080.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:columns -->
