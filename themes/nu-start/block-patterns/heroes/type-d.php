	...
	register_block_pattern(
		...
		array(
			...
			'content'     => '
				...
				<div class="wp-block-group alignfull nu_pattern-is_hero--is_type_d"><!-- wp:cover {"url":"http://nu-start.local/wp-content/uploads/1920x1080.png","id":49,"dimRatio":30,"overlayColor":"black","minHeight":30,"minHeightUnit":"vw","align":"full","className":"cover_tucks_next_block"} -->
				...
				<div class="wp-block-button is-style-playhead"><a class="wp-block-button__link" href="https://www.youtube.com/watch?v=8YswvEWMotk" target="_blank" rel="noreferrer noopener">Informative Video</a></div>
				<!-- /wp:button --></div>
				<!-- /wp:buttons --></div></div>
				<!-- /wp:cover -->
