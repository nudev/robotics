...
if( function_exists('acf_register_block_type') ):
	...
	acf_register_block_type(array(
		...
		'align' => '',
		'align_content' => NULL,
		'render_template' => 'acf-blocks/breadcrumbs/breadcrumbs.php',
		'render_callback' => '',
		'enqueue_style' => 'acf-blocks/breadcrumbs/breadcrumbs.css',
		'enqueue_script' => 'acf-blocks/breadcrumbs/breadcrumbs-min.js',
		'enqueue_assets' => '',
		'icon' => '',
		'supports' => array(
			'align' => array(
...
if( function_exists('acf_register_block_type') ):
	...
	acf_register_block_type(array(
		...
		'align' => '',
		'align_content' => NULL,
		'render_template' => 'acf-blocks/programs/program.php',
		'render_callback' => '',
		'enqueue_style' => 'acf-blocks/programs/program.css',
		'enqueue_script' => 'acf-blocks/programs/program-min.js',
		'enqueue_assets' => '',
		'icon' => '',
		'supports' => array(
			'align' => array(
...
if( function_exists('acf_register_block_type') ):
	...
	acf_register_block_type(array(
		...
		'align' => '',
		'align_content' => NULL,
		'render_template' => 'acf-blocks/nav-menu/nav-menu.php',
		'render_callback' => '',
		'enqueue_style' => 'acf-blocks/nav-menu/nav-menu.css',
		'enqueue_script' => 'acf-blocks/nav-menu/nav-menu-min.js',
		'enqueue_assets' => '',
		'icon' => '',
		'supports' => array(
			'align' => true,
...
if( function_exists('acf_register_block_type') ):
	...
	acf_register_block_type(array(
		...
		'align' => 'full',
		'align_content' => NULL,
		'render_template' => 'acf-blocks/carousel/carousel.php',
		'render_callback' => '',
		'enqueue_style' => 'acf-blocks/carousel/carousel.css',
		'enqueue_script' => 'acf-blocks/carousel/carousel-min.js',
...
if( function_exists('acf_register_block_type') ):
	...
	acf_register_block_type(array(
		...
		'align' => '',
		'align_content' => NULL,
		'render_template' => 'acf-blocks/posts-grid/posts-grid.php',
		'render_callback' => '',
		'enqueue_style' => 'acf-blocks/posts-grid/posts-grid.css',
		'enqueue_script' => 'acf-blocks/posts-grid/posts-grid-min.js',
		'enqueue_assets' => '',
		'icon' => '',
		'supports' => array(
			'align' => array(
